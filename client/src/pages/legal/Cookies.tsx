...
export function Cookies() {
  return (
    <div className="max-w-4xl mx-auto p-8">
      <SEO title="Cookie Policy" description="Cookie usage." />
      ...
      <GlassCard className="prose prose-invert max-w-none space-y-4 text-gray-300">
        <p>PostDoctor AI uses cookies to improve your experience. By using our service, you agree to our use of cookies.</p>
