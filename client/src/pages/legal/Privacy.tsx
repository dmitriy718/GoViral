  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <GlassCard className="prose prose-invert max-w-none space-y-4 text-gray-300">
        <p>At ViralPost AI, we are committed to protecting your privacy. This Privacy Policy explains how we collect, use, and disclose your personal information.</p>
