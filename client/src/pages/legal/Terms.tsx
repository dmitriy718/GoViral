  ...
  return (
    <div className="max-w-4xl mx-auto p-8">
      ...
      <GlassCard className="prose prose-invert max-w-none">
        ...
        <p>By accessing and using ViralPost AI, you accept and agree to be bound by the terms and provision of this agreement.</p>
        
        <h3>2. Service Description</h3>
        <p>ViralPost AI provides AI-powered social media management tools. We reserve the right to modify or discontinue the service at any time.</p>
